...
// Debounce Test
const printHelloDebounce = () => console.log("hello from debounce");
const debouncedFn = debounce(printHelloDebounce, 1000);
...
// Throttle Test
const printHelloThrottle = () => console.log("hello from throttle");
const throttledFn = throttle(printHelloThrottle, 1000);

throttledFn();
throttledFn();
setTimeout(throttledFn, 1200);
